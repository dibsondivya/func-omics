...
# NOTE:
gseGO should be run on all genes, with the logFC ranked. 
enrichGO should be run on genes identified to be significant. 

The below analysis does not follow this! TO AVOID.
